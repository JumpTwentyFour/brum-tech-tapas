 ...
 * .env file support
 *
 * For this to work locally, you need to run composer install in the root directory.
 * This is the only dependency using composer on this project.
 *
 * This is needed by Envoyer (and Forge), which writes the environment variables to an .env file.
 */
...
/** Disable when in development */
if (WP_ENV === 'development') {
    define('WP_DISABLE_FATAL_ERROR_HANDLER', true); // Prevents the "Your Site is Experiencing a Technical Issue" e-mails
}
